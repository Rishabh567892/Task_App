...
import { deleteTask, fetchTasks } from '../Backend_Operations'

const Delete = ({ taskNumber, setTasks }) => {

  const { setMessage } = useAppContext()

  const handleOnClick = async () => {

    let response = await deleteTask(taskNumber);
  ...
  return (
    <div className='cursor-pointer flex items-center hover:bg-zinc-200' onClick={handleOnClick}>
